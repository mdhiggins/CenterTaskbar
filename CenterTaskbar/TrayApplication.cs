...
namespace CenterTaskbar
{
    public class TrayApplication : ApplicationContext
    {
        ...
        private readonly Dictionary<AutomationElement, AutomationElement> _children = new();

        private readonly Dictionary<AutomationElement, double> _lasts = new();

        private readonly NotifyIcon _trayIcon;

        // private Thread positionThread;
        private readonly Dictionary<AutomationElement, Task> _positionThreads = new();
        ...
        public TrayApplication(IReadOnlyList<string> args)
        {
            ...
            var header = new ToolStripMenuItem("CenterTaskbar (" + _activeFramerate + ")", null, Exit)
            {
                Enabled = false
            };

            var startup = new ToolStripMenuItem("Start with Windows", null, ToggleStartup)
            {
            ...
            _trayIcon = new NotifyIcon
            {
                ...
                ContextMenuStrip = new ContextMenuStrip
                {
                    Items = {
                    header,
                    new ToolStripMenuItem("Scan for screens", null, Restart),
                    startup,
